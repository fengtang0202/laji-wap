<template>  
  <div id="demo">  
    ...
    <div style="padding:.2rem .4rem;float:right">  
        <div class="show">  
          <div class="picture" :style="'backgroundImage:url('+headerImage+')'">  
        </div>  
        </div>  
        <div style="opacity:0;width:80%;position:absolute;top:0;right:0;height:.92rem;">  
          <input type="file" id="change" style="height:100%;" accept="image" @change="change">  
...
export default {  
  ...
  methods: {  
    ...
    change (e) {  
      ...
      // if(this.picValue.size/1024/1024){
      // }  
