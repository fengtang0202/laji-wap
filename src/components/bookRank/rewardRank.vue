     ...
     export default{
        data(){
           return{
             ...
             rankBookList:[],
             dayList:[
                 {day:'周',key:'week',link:'rewardRank?dayType=week'},
                 {day:'月',key:'month',link:'rewardRank?dayType=month'},
                 {day:'总',key:'total',link:'rewardRank?dayType=total'}
             ], 
             page:0,
             changeDayColor:0
           }
        ...
        methods:{
           handleInitDay(){
             ...
             infiniteHandler($state){
                let self = this;
                self.page+=1
                Post_formData2(self,{type:8 ,page:self.page},'/api/ranking-book',res=>{
                             let lists=null
              ...
              handleBook(){
                Post_formData2(this,{type:8,page:this.page},'/api/ranking-book',res=>{
                 if(res.returnCode==200){
